...
- **Transport:** **Twilio/Plivo direct, GV re-login paths.** _(⚠️ Twilio-direct is BANNED — that's why **Telnyx+FreeSWITCH** is the sanctioned direction.)_ **Phound: NOT banned (reinstated 2026-06-15)** — it's the only universal phone-line-aggregation + call-flow tool; allowed until a replacement exists.
